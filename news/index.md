...
- added get_response argument to resp_body_json_to_df() and all get\_\*
  functions in order to be able to return the raw response from the API
...
- added aggregations_project_detections_count, where you can also
  specify groups like recorder and species
...
- added get_by_url() to get linked URL endpoints from other get
  functions
...
- adapted patch_detection() to be able to patch empty/ blank comments
  (i.o.w. deleting old comments)
